    ...
    <>
      ...
      {localStorage.getItem("accessToken") ? (
        <div className="not-found">
          ...
          <h1 style={{ fontSize: "40px" }}>You are signed in</h1>
          <button
                ...
                >
                  <div className="sign-in">
                    ...
                    <div className="form-control-authentication">
                      <input
                        type={
                          /\D/.test(studentIdOrEmailForSignIn)
                            ? "email"
                            : "text"
                        }
                        name=""
                    ...
                    {isEmailVerified && (
                      <>
                        ...
                        {!isValidLength && (
                          ...
                          >
                            <p>
                              <i className="fa-solid fa-x"></i> Minimum length
                              of 12 characters
                            </p>
                          </div>
                        )}
            ...
            <div className="modal-content">
              ...
              <div className="policy-section">
                ...
                <ul>
                  ...
                  <li>
                    Disrupt, interfere with, or attempt unauthorized access to
              ...
              <div className="policy-section">
                ...
                <ul>
                  ...
                  <li>
                    Modify or temporarily disable any part of the website
              ...
              <div className="policy-section">
                ...
                <ul>
                  <li>
                    You <strong>MUST</strong> provide a detailed description of
                    the lost item for verification with the holder.
                  </li>
                  <li>
                    You are <strong>REQUIRED</strong> to create a post in order
                    to receive a verification code.
                  </li>
                  <li>
                    The post <strong>MUST</strong> include a complete and
                    accurate description of the lost item.
                  </li>
                  <li>
                    Users are responsible for regularly checking their post on
              ...
              <div className="policy-section">
                ...
                <ul>
                  <li>
                    ...
                    claimant's verification code and item description to ensure
                    they match the item in your possession.
                  </li>
                  <li>
